...
use Yii;
use hospital\models\Worker;
use hospital\models\search\WorkerSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class WorkerController extends SoftController
{
    ...
    */
    ...
    /**
    * Delete multiple existing Worker model.
    ...
    */
    ...
    {
        $model = Worker::find()->andWhere(['id' => $id])->one();
        if ($model == null){
            not_found();
        }
        return $model;
